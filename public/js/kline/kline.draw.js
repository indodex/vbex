var GLOBAL_VAR = {
    ...
    button_down: false,
    init: false,
    url: DOMAIN_TRANS + "/api/v1/market/klineLastData"
//	url: "/testData.php"
};
...
LightTheme.prototype.__construct = function() {
    ...
    this._colors[Theme.Color.Unchanged] = "#fff";
    this._colors[Theme.Color.Background] = "#1f1d1d";
    this._colors[Theme.Color.Cursor] = "#aaa";
    this._colors[Theme.Color.RangeMark] = "#f9ee30";
    this._colors[Theme.Color.Indicator0] = "#ddd";
    this._colors[Theme.Color.Indicator1] = "#f9ee30";
    ...
    this._colors[Theme.Color.LineColorNormal] = "#a6a6a6";
    this._colors[Theme.Color.LineColorSelected] = "#ffffff";
    this._colors[Theme.Color.CircleColorFill] = "#1a1f24";
    this._colors[Theme.Color.CircleColorStroke] = "#ffffff";
    this._fonts = [];
    this._fonts[Theme.Font.Default] = "12px Tahoma"
}
...
function sendChannel(a) {
    ...
    var b = setInterval(function() {
        ...
        if (top.webSocket) {
            top.webSocket.sendMessage(a);
            clearInterval(b)
        }
    }, 20)
}
var init = true;
var lan = document.cookie.match(/(^| )lang=([^;]*)(;|$)/);
if(lan){
	lan = unescape(lan[2]);
}else{
	lan = 'zh-cn';
...
function updateKlineData(a) {
    var c = kline.symbol + "_kline_" + GLOBAL_VAR.time_type;
    if (c != a.channel) {
        console.log(a.channel + "---" + c + " channel不同不处理");
        return
    }
    GLOBAL_VAR.market_from_name = a.datas.marketName;
    var b = ChartManager.getInstance().getChart();
    b._contract_unit = a.datas.contractUnit;
    b._money_type = a.datas.moneyType;
    b._usd_cny_rate = a.datas.USDCNY;
    b.setTitle();
    kline.setMarketShow(GLOBAL_VAR.market_from_name, b._contract_unit, b._money_type, a.datas.url);
    kline.setTopTickers(a.datas.topTickers);
    GLOBAL_VAR.KLineData = a.datas.data;
...
function on_size() {
    ...
    v.y = 0;
    v.w = u;
    v.h = z.is(":visible") ? parseInt(z.css("height")) : 0;
    var f = {};
    f.x = 0;
//  f.y = v.h + 1;
	f.y = v.h;
