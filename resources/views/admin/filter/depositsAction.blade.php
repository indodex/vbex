<div class="btn-group pull-left">
    <a href="" class="btn btn-sm btn-info" data-toggle="modal" data-target="#apply-modal-{{ $row->id }}" data-id="-{{ $row->id }}"><i class="fa fa-send"></i>&nbsp;&nbsp;{{ trans('api.recharge.apply') }}</a>
</div>
                    ...
                    <div class="form">
                        ...
                        <div class="input-group">
                            <div class="radio">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="status" value="0" class="minimal" />&nbsp;{{ trans('api.withdraw.withdraws_refuse') }}&nbsp;&nbsp;
                                </label>
                            </div>
                        </div>
                    </div>
