<template>
      	<div class="modal-body" >
            <form action="javascript:;" :model="googleForm" ref="googleForm">
            	...
            	<div class="form-group">
            		<input class="form-control" v-model="googleForm.oldGoogleCode" :placeholder="$tc('member.googleCodeOld',1)"/>
            	</div>
                <div class="form-group">
                    <input class="form-control" v-model="googleForm.googleCode" :placeholder="$tc('member.googleCodeNew',1)"/>
                </div>
            	<div class="form-group">
...
export default{
	...
	methods:{
		close(){
            ...
            var vm = this
            vm.okloaded = false;
            axios.post(this.commonApi.api.changeGoogleSecret, {
                googleSecret:vm.secret,
                oldGoogleCode:vm.googleForm.oldGoogleCode,
