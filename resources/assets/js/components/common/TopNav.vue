                ...
                <div class="navbar-collapse collapse " aria-expanded="true">
                    <ul class="nav navbar-nav fs-14">
                        ...
                        <li class="market-slidown">
                        	<!--nav have to before the a element , the arrow will be shown-->
                        ...
                        <li>
                            <!--<div class="navbar-nav-slidown">
                                <router-link to="/news">公告</router-link>
                                <a>帮助</a>
                                <a>关于</a>
                            </div>-->
                            <!--<a>网站导航<i class="fa fa-angle-down"></i></a>-->
									...
									<div class="tb-ctn">
										<ul class="tb-list" v-if="balances.list" >
											<li v-for="item in balances.list" class="clearfix text-gray-light" v-show="!(item.totalStr == 0&&toggleCode)">
												...
												<!--<div class="col-xs-4">{{item.totalStr}}</div>-->
												<!--<div class="col-xs-4 text-right">{{item.lockedBalanceStr}}</div>-->
